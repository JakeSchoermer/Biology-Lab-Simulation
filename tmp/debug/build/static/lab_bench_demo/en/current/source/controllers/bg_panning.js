...
/** @scope LabBenchDemo.bgPanning.prototype */ {
		...
		var direction = input.get('direction'),
			...
			//Handle Selectors
			/*PippetContainerSelector BubbleBathSolutionSelector LabJackSelector MuscleTissueSelector GasLineSelector*/
			
			LabBenchDemo.mainPage.mainPane.AppCanvas.WidgetContainer.SafetyDisposalSelector.set('layout', {width: newWidth*0.086, height: newHeight*0.24, left: newWidth*0.02, top: newHeight*0.52});
			LabBenchDemo.mainPage.mainPane.AppCanvas.WidgetContainer.PippetContainerSelector.set('layout', {width: newWidth*0.0951, height: newHeight*0.08, left: newWidth*0.098, top: newHeight*0.85});
			LabBenchDemo.mainPage.mainPane.AppCanvas.WidgetContainer.BubbleBathSolutionSelector.set('layout', {width: newWidth*0.055, height: newHeight*0.180, left: newWidth*0.66, top: newHeight*0.04});
			LabBenchDemo.mainPage.mainPane.AppCanvas.WidgetContainer.LabJackSelector.set('layout', {width: newWidth*0.138, height: newHeight*0.335, left: newWidth*0.43, top: newHeight*0.45});
			LabBenchDemo.mainPage.mainPane.AppCanvas.WidgetContainer.MuscleTissueSelector.set('layout', {width: newWidth*0.055, height: newHeight*0.41875, left: newWidth*0.680, top: newHeight*0.4});
			LabBenchDemo.mainPage.mainPane.AppCanvas.WidgetContainer.GasLineSelector.set('layout', {width: newWidth*0.078, height: newHeight*0.255, left: newWidth*0.885, top: newHeight*0.6});
