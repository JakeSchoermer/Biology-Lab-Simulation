  ...
  // TODO: Add your own code here.
    _cardPool:[],
		...
		card = LabBenchDemo.PippView.create({
			init:function(){
				...
				this.frontView.set('widgetPicture','/static/lab_bench_demo/en/current/resources/images/yelpipclose.png?1291274261');
			}
		});
    ...
    createbluePipp: function(){
		...
		card = LabBenchDemo.PippView.create({
					init:function(){
						arguments.callee.base.apply(this,arguments);
						this.frontView.set('widgetPicture','/static/lab_bench_demo/en/current/resources/images/pipBlueNum.png?1288229640');
					}
		});
